...
/*   Updated: 2024/10/16 16:59:44 by mochenna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define ERRO_NNUM \
	"OPS! you have  invalid argument [the number can not be negative]\n"
...
# define ERRO_INVARGEMTY \
	"OPS! you have  invalid argument [ the string is emty]\n"
# define ERRO_INVARG_NOT_INT \
	"OPS! you have  invalid argument \
